...
const recomendacionSQL= (genero, anioInicio, anioFin, puntuacion) => {
  ...
  if (genero != undefined && anioInicio != undefined && anioFin != undefined) {
    sql = "SELECT p.id AS id, p.titulo AS titulo, p.duracion AS duracion, p.director AS director, p.fecha_lanzamiento AS fecha_lanzamiento, p.anio AS anio, p.puntuacion AS puntuacion, p.poster AS poster, p.trama AS trama, p.genero_id AS genero_id, g.nombre AS genero FROM peliculas p INNER JOIN generos g ON p.genero_id = g.id WHERE g.nombre = '" + genero + "' AND ( fecha_lanzamiento >= '" + anioInicio + "' AND fecha_lanzamiento <= '" + anioFin + "' )";
  }else if(anioInicio != undefined && anioFin != undefined) {
    sql = "SELECT p.id AS id, p.titulo AS titulo, p.duracion AS duracion, p.director AS director, p.fecha_lanzamiento AS fecha_lanzamiento, p.anio AS anio, p.puntuacion AS puntuacion, p.poster AS poster, p.trama AS trama, p.genero_id AS genero_id, g.nombre AS genero FROM peliculas p INNER JOIN generos g ON p.genero_id = g.id WHERE ( fecha_lanzamiento >= '" + anioInicio + "' AND fecha_lanzamiento <= '" + anioFin + "' )";
  }else if(genero != undefined && puntuacion != undefined){
    sql = "SELECT p.id AS id, p.titulo AS titulo, p.duracion AS duracion, p.director AS director, p.fecha_lanzamiento AS fecha_lanzamiento, p.anio AS anio, p.puntuacion AS puntuacion, p.poster AS poster, p.trama AS trama, p.genero_id AS genero_id, g.nombre AS genero FROM peliculas p INNER JOIN generos g ON p.genero_id = g.id WHERE g.nombre = '" + genero + "' AND p.puntuacion >= '" + puntuacion + "'";
  }else if(puntuacion != undefined){
    sql = "SELECT p.id AS id, p.titulo AS titulo, p.duracion AS duracion, p.director AS director, p.fecha_lanzamiento AS fecha_lanzamiento, p.anio AS anio, p.puntuacion AS puntuacion, p.poster AS poster, p.trama AS trama, p.genero_id AS genero_id, g.nombre AS genero FROM peliculas p INNER JOIN generos g ON p.genero_id = g.id WHERE  p.puntuacion >= '" + puntuacion + "'";
  }else {
    sql = "SELECT p.id AS id, p.titulo AS titulo, p.duracion AS duracion, p.director AS director, p.fecha_lanzamiento AS fecha_lanzamiento, p.anio AS anio, p.puntuacion AS puntuacion, p.poster AS poster, p.trama AS trama, p.genero_id AS genero_id, g.nombre AS genero FROM peliculas p INNER JOIN generos g ON p.genero_id = g.id WHERE g.nombre = '" + genero + "'";
  }
  return sql;
